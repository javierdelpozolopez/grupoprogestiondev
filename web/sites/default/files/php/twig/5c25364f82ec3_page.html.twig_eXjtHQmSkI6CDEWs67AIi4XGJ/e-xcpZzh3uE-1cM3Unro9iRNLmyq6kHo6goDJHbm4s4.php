...
($context["secondary_menu"] ?? null)) ? ("with-subnav") : (""))), "method"), "html", null, true));
  ...
  <div id=\"main\">
      ...
      <div id=\"content-wrapper\">
        ...
        if ($this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->getAttribute(($context["page"] ?? null), "two_grid_content", array()))) {
          ...
          <div class=\"flex-col-ss\">
              <h4 class=\"color-primary\">¡Escríbenos!</h4>
              <h6>te responderemos a la brevedad</h6>
            </div>
            ";
            // line 91
    ...
    <div class=\"container-bg__primary__color padding-3-0\">
      <div class=\"container\">
            ";
        // line 117
...
<div{{ attributes.addClass(
  ...
  {% if page.main_menu or secondary_menu %}
  ...
  <div id=\"main\">
    ...
    {% if page.page_title %}
    <div class=\"container-bg__title\">
      <div class=\"container\">
            {{ page.page_title }}
      </div>
    </div>
    {% endif %}
    {% if page.difrent_bg_content %}
    <div class=\"container-bg__secondary__color\">
      <div class=\"container\">
            {{ page.difrent_bg_content }}
      </div>
    </div>
    {% endif %}
    <div class=\"container\">
      <div id=\"content-wrapper\">
        <section class=\"main-content\" id=\"content\">
          ...
          {% if page.two_grid_content |render %}
          <div id=\"two-grid-content\" class=\"grid grid-2 padding-1-0-1-0\">
          <div class=\"flex-col-ss\">
              <h4 class=\"color-primary\">¡Escríbenos!</h4>
              <h6>te responderemos a la brevedad</h6>
            </div>
            {{ page.two_grid_content }}
          </div>
        {% endif %}
  ...
  {% endif %}
  {% if page.footer_small|render %}
    <div class=\"footer-small__container\" id=\"footer-small\">
      <div class=\"container\">
        <div id=\"footer-small-region\">
          {{ page.footer_small }}
        </div>
...
", "themes/contrib/basic/templates/page.html.twig", "C:\\xampp\\htdocs\\desarrollos\\grupoprogestiondev\\web\\themes\\contrib\\basic\\templates\\page.html.twig");
    }
}
