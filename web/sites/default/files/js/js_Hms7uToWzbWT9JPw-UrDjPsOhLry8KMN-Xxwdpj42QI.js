...
;
"use strict";function injectMenu(e){window.innerWidth<e?(hMenu.classList="hamburger-menu",console.log("Se inyectó el menú xoro")):(hmenu.classList.remove="hamburger-menu",console.log("adios"))}var hMenu=document.getElementById("js-hamburger-menu");document.addEventListener("resize",function(e){console.log(window.innerWidth)}),console.log("asdfasdf");
