...
;
"use strict";var hamburgerMenu=document.getElementById("js-hamburger-menu"),injectMenu=function(e){window.innerWidth<e?console.log("Se inyectó el menú xoro"):console.log("se borró")},callMenu=function(){console.log("pollito"),document.getElementById("js-main-menu").classList.toggle("main-menu__active")};hamburgerMenu&&(window.addEventListener("resize",function(e){injectMenu(window.innerWidth)}),console.log("el menu existe")),hamburgerMenu.addEventListener("click",callMenu()),console.log("termino menu");
