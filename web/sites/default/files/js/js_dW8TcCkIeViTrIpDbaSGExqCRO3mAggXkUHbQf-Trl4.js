...
;
"use strict";var hamburgerMenu=document.getElementById("js-hamburger-menu");hamburgerMenu.classList="hamburger-menu";var injectMenu=function(n){n<720?console.log("Se inyectó el menú xoro"):console.log("se borró")},callMenu=function(){document.getElementById("js-main-menu").classList.toggle("main-menu__active")};hamburgerMenu&&(window.addEventListener("resize",function(n){injectMenu(window.innerWidth)}),hamburgerMenu.addEventListener("click",function(n){callMenu()}));var menuId=document.getElementById("js-main-menu-empresas"),empBoxContainer=document.createElement("div"),empBoxContent=document.createElement("div");menuId.classList="menu-emp__active",empBoxContainer.classList="menu-emp__container",empBoxContent.classList="menu-emp__content",menuId.textContent.includes("empresas")&&(empBoxContent.innerHTML='\n    <div class="grid grid-3">\n        <div class="flex-col-ss">\n            <img src="" alt="logo">\n            <h3>Outsourcing, selección y gestión integral</h3>\n            <a href="">Más información</a>\n        </div>\n        <div class="flex-col-ss">\n            <img src="" alt="logo">\n            <h3>Outsourcing, selección y gestión integral</h3>\n            <a href="">Más información</a>\n        </div>\n        <div class="flex-col-ss">\n            <img src="" alt="logo">\n            <h3>Outsourcing, selección y gestión integral</h3>\n            <a href="">Más información</a>\n        </div>\n        <div class="flex-col-ss">\n            <img src="" alt="logo">\n            <h3>Outsourcing, selección y gestión integral</h3>\n            <a href="">Más información</a>\n        </div>\n        <div class="flex-col-ss">\n            <img src="" alt="logo">\n            <h3>Outsourcing, selección y gestión integral</h3>\n            <a href="">Más información</a>\n        </div>\n        <div class="flex-col-ss">\n            <img src="" alt="logo">\n            <h3>Outsourcing, selección y gestión integral</h3>\n            <a href="">Más información</a>\n        </div>\n        <div class="flex-col-ss">\n            <img src="" alt="logo">\n            <h3>Outsourcing, selección y gestión integral</h3>\n            <a href="">Más información</a>\n        </div>\n    </div>\n    ',empBoxContainer.appendChild(empBoxContent),menuId.addEventListener("mouseover",function(n){n.stopPropagation,n.preventDefault,menuId.appendChild(empBoxContainer),console.log("el menu empresas aparece")}),menuId.addEventListener("mouseleave",function(n){n.stopPropagation,n.preventDefault,menuId.removeChild(empBoxContainer),console.log("el menu empresas desaparece")}));
