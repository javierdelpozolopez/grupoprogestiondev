...
;
"use strict";var eProgestionId=document.getElementById("js-emp-progestion-content"),eProgestionHeroId=document.getElementById("js-emp-progestion-hero"),eProgestionMenuId=document.getElementById("js-emp-progestion-menu"),eProgestionMenuContent=document.createElement("div"),eProgestionContainer=document.createElement("div");if(eProgestionHeroId){var eProgestionHeroContent=document.createElement("div"),imageUrl="./../themes/contrib/basic/images/source/",logo=new Image;logo.src=imageUrl+"svg/logo-progestion.svg",eProgestionHeroContent.innerHTML='\n    <div class="flex-column-cc text-align-center padding-3-0 max-w-720">\n        <img class="icon-bigger margin-bottom-2" src="'+logo.src+'" alt="Logo Progestion">\n        <h1></h1>\n        <p></p>\n    </div>\n    ',eProgestionHeroId.appendChild(eProgestionHeroContent)}if(eProgestionMenuId){var selectTab=function(e){selectedTab&&(selectedTab.className="js-capture-id"),e.className="btn__deploy",selectedTab=e};eProgestionMenuContent.classList="top-bar__content",eProgestionMenuContent.innerHTML='\n    <div class="flex-row-cse head-menu margin-bottom-2">\n        <li onclick="selectTab(this)" class="js-capture-id" id="desarrollodesoftware"><p>Desarrollo de software</p></li>\n        <li onclick="selectTab(this)" class="js-capture-id" id="bi"><p>BI</p></li>\n        <li onclick="selectTab(this)" class="js-capture-id" id="aplicaciones"><p>Aplicaciones</p></li>\n    </div>\n    ',eProgestionMenuId.appendChild(eProgestionMenuContent);var eProgestionImgTrade=new Image,eProgestionImgSupply=new Image,eProgestionImgProgestion=new Image,_imageUrl="./../themes/contrib/basic/images/source/";eProgestionImgTrade.src=_imageUrl+"emp-progestion.jpg",eProgestionImgSupply.src=_imageUrl+"emp-progestion.jpg",eProgestionImgProgestion.src=_imageUrl+"emp-progestion.jpg";var desarrollodeSoftwareInfo='\n    <div class="grid-2-no-gap">\n        <div class="box-bg-img" style="background-image:url(\''+eProgestionImgTrade.src+'\');"></div>\n        <div class="flex-col-sc padding-3-2">\n            <h1></h1>\n            <h4></h4>\n        </div>\n    </div>\n\n    <div class="grid-2-no-gap">\n        <div class="flex-col-sc padding-3-2">\n            <h1></h1>\n            <h4></h4>\n        </div>\n        <div class="box-bg-img" style="background-image:url(\''+eProgestionImgTrade.src+"');\"></div>\n    </div>\n    ",biInfo='\n    <div class="grid-2-no-gap">\n        <div class="box-bg-img" style="background-image:url(\''+eProgestionImgTrade.src+'\');"></div>\n        <div class="flex-col-sc padding-3-2">\n            <h1></h1>\n            <h4></h4>\n        </div>\n    </div>\n    <div class="grid-2-no-gap">\n        <div class="flex-col-sc padding-3-2">\n            <h1></h1>\n            <h4></h4>\n        </div>\n        <div class="box-bg-img" style="background-image:url(\''+eProgestionImgTrade.src+'\');"></div>\n    </div>\n    <div class="grid-2-no-gap">\n        <div class="box-bg-img" style="background-image:url(\''+eProgestionImgTrade.src+'\');"></div>\n        <div class="flex-col-sc padding-3-2">\n            <h1></h1>\n            <h4></h4>\n        </div>\n    </div>\n    ',aplicacionesInfo='\n<div class="grid-2-no-gap">\n<div class="box-bg-img" style="background-image:url(\''+eProgestionImgTrade.src+'\');"></div>\n<div class="flex-col-sc padding-3-2">\n    <h1></h1>\n    <h4></h4>\n</div>\n</div>\n<div class="grid-2-no-gap">\n<div class="flex-col-sc padding-3-2">\n    <h1></h1>\n    <h4></h4>\n</div>\n<div class="box-bg-img" style="background-image:url(\''+eProgestionImgTrade.src+'\');"></div>\n</div>\n<div class="grid-2-no-gap">\n<div class="box-bg-img" style="background-image:url(\''+eProgestionImgTrade.src+'\');"></div>\n<div class="flex-col-sc padding-3-2">\n    <h1></h1>\n    <h4></h4>\n</div>\n</div>\n<div class="grid-2-no-gap">\n<div class="flex-col-sc padding-3-2">\n    <h1></h1>\n    <h4></h4>\n</div>\n<div class="box-bg-img" style="background-image:url(\''+eProgestionImgTrade.src+"');\"></div>\n</div>\n",callService=function(e){e.preventDefault;var n=[e.currentTarget.id];"desarrollodesoftware"==n?eProgestionId.innerHTML=desarrollodeSoftwareInfo:"bi"==n?eProgestionId.innerHTML=biInfo:"aplicaciones"==n&&(eProgestionId.innerHTML=aplicacionesInfo)},menuServicesCaptId=Array.from(document.getElementsByClassName("js-capture-id"));menuServicesCaptId.map(function(e){return e.addEventListener("click",callService,!0)});var selectedTab=null;eProgestionId.innerHTML=desarrollodeSoftwareInfo}
