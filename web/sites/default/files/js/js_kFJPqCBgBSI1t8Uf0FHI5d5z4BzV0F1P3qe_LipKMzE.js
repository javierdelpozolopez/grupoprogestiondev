...
;
"use strict";function injectMenu(e){var n=!1;window.innerWidth<e&&0==n?(haMenu.classList="hamburger-menu",n=!0,console.log("Se inyectó el menú xoro")):(hmenu.classList.remove="hamburger-menu",console.log("adios"))}var haMenu=document.getElementById("js-hamburger-menu");hamenu&&console.log("si existe loco"),window.addEventListener("resize",function(e){console.log("memememe"),haMenu&&injectMenu(window.innerWidth)}),console.log("asdfasdf");
