...
;
"use strict";console.log("contact-info");var contactInfoContainer=document.getElementById("js-contactcontainer"),contactInfoContent=document.createElement("div");contactInfoContent.className("contact-info__content"),contactInfoContent.innerHTML='\n<div class="contact-info__title"><h1 class="text__white">CONTÁCTANOS A:</h1></div>\n<div class="contact-info__box box__icon">\n<img class="contact-info__icon" src="" alt="">\n<img class="contact-info__icon" src="" alt="">\n</div>\n<div class="contact-info__content-box grid contact-info-grid">\n    <div class="contact-info__box box__banderas"></div>\n    <div class="contact-info__box box__correo">\n        <h4>comercial.chile@grupoprogestion.com</h4>\n        <h4>comercial.peru@grupoprogestion.com</h4>\n    </div>\n    <div class="contact-info__box box__telefono">\n        <h4>Tel: (+56 2) 2433 6500</h4>\n        <h4>Tel: (+52) 55 5250 4056</h4>\n    </div>\n</div>\n',contactInfoContainer.appendChild(contactInfoContent);
