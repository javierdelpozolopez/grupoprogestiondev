...
;
"use strict";function injectMenu(e){window.innerWidth<e?(hamgurgerMenu.classList="hamburger-menu",console.log("Se inyectó el menú xoro")):window.innerWidth>e&&(hamgurgerMenu.classList.remove="hamburger-menu",console.log("se borró"))}var hamgurgerMenu=document.getElementById("js-hamburger-menu");hamgurgerMenu&&window.addEventListener("resize",function(e){injectMenu(window.innerWidth),window.innerWidth<720&&hamgurgerMenu.addEventListener("click",function(e){console.log("pollito"),document.getElementById("js-main-menu").classList.toggle("main-menu__active")})});
