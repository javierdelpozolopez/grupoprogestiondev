...
;
"use strict";var hamburgerMenu=document.getElementById("js-hamburger-menu"),injectMenu=function(e){window.innerWidth<e?(hamburgerMenu.classList="hamburger-menu",console.log("Se inyectó el menú xoro")):window.innerWidth>e&&(hamburgerMenu.classList.remove="hamburger-menu",console.log("se borró"))},callMenu=function(){console.log("pollito"),document.getElementById("js-main-menu").classList.toggle("main-menu__active")};hamburgerMenu&&(window.addEventListener("resize",function(e){injectMenu(window.innerWidth)}),hamburgerMenu.addEventListener("click",callMenu(),!0),console.log("el menu existe")),console.log("termino menu");
