...
;
"use strict";var hamburgerMenu=document.getElementById("js-hamburger-menu");hamburgerMenu.classList="hamburger-menu";var injectMenu=function(e){e<720?console.log("Se inyectó el menú xoro"):console.log("se borró")},callMenu=function(){document.getElementById("js-main-menu").classList.toggle("main-menu__active")};hamburgerMenu&&(window.addEventListener("resize",function(e){injectMenu(window.innerWidth)}),hamburgerMenu.addEventListener("click",function(e){callMenu()}));var menuElClass=document.getElementById("js-main-menu-empresas"),EmpBoxContent=document.createElement("div");menuElClass.id="js-menu-empresas",EmpBoxContent.classList="menu-emp__box",(menuElClass.id="js-menu-empresas")&&console.log(menuElClass);
