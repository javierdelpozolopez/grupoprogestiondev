...
;
"use strict";!function(o,n){o.behaviors.basic={attach:function(o,i){n(window).on("load",function(){console.log("hola")}),n(window).on("resize",function(){}),n(window).on("scroll",function(){})}}}(Drupal,jQuery);
