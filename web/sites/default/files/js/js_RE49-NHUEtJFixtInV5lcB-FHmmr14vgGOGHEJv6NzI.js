...
;
"use strict";function injectMenu(e){window.innerWidth<e?(hamburgerMenu.classList="hamburger-menu",console.log("Se inyectó el menú xoro")):window.innerWidth>e&&(hamburgerMenu.classList.remove="hamburger-menu",console.log("se borró"))}function callMenu(){console.log("pollito"),document.getElementById("js-main-menu").classList.toggle("main-menu__active")}var hamburgerMenu=document.getElementById("js-hamburger-menu");hamburgerMenu&&(window.addEventListener("resize",function(e){injectMenu(window.innerWidth)}),hamburgerMenu.addEventListener("click",callMenu(),!0));
