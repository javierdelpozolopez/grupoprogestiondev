...
;
"use strict";function injectMenu(e){var n=!1;window.innerWidth<e&&0==n?(hamgurgerMenu.classList.add="hamburger-menu",n=!0,console.log("Se inyectó el menú xoro")):1==n&&(hamgurgerMenu.classList.remove="hamburger-menu",console.log("se borró"))}var hamgurgerMenu=document.getElementById("js-hamburger-menu");hamgurgerMenu&&window.addEventListener("resize",function(e){injectMenu(window.innerWidth),console.log("asdasd")});
