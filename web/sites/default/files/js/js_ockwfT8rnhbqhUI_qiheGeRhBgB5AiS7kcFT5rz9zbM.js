...
;
"use strict";function injectMenu(e){var n=!1;window.innerWidth<e&&0==n?(hMenu.classList="hamburger-menu",n=!0,console.log("Se inyectó el menú xoro")):(hmenu.classList.remove="hamburger-menu",console.log("adios"))}var hMenu=document.getElementById("js-hamburger-menu");hmenu&&console.log("si existe loco"),window.addEventListener("resize",function(e){document.getElementById("js-hamburger-menu")&&injectMenu(window.innerWidth)}),console.log("asdfasdf");
