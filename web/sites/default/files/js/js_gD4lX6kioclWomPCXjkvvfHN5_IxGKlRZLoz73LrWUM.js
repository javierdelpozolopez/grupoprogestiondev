...
;
"use strict";function injectMenu(e){window.innerWidth<e?(hamburgerMenu.classList="hamburger-menu",console.log("Se inyectó el menú xoro")):window.innerWidth>e&&(hamburgerMenu.classList.remove="hamburger-menu",console.log("se borró"))}var hamburgerMenu=document.getElementById("js-hamburger-menu"),callMenu=function(){console.log("pollito"),document.getElementById("js-main-menu").classList.toggle("main-menu__active")};hamburgerMenu&&(window.addEventListener("resize",function(e){injectMenu(window.innerWidth)}),hamburgerMenu.addEventListener("click",callMenu,!0)),console.log("termino menu");
