...
;
"use strict";function injectMenu(e){var n=!1;window.innerWidth<e&&0==n?(hamgurgerMenu.classList.add="hamburger-menu",n=!0,console.log("Se inyectó el menú xoro")):hamgurgerMenu.classList.remove="hamburger-menu"}var hamgurgerMenu=document.getElementById("js-hamburger-menu");hamgurgerMenu&&console.log("si existe loco"),window.addEventListener("resize",function(e){hamgurgerMenu&&injectMenu(window.innerWidth)});
