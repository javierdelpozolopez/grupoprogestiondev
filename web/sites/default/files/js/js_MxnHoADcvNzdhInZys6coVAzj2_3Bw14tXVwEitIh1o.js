...
;
"use strict";var hMenu=document.getElementById("js-hamburger-menu");document.addEventListener("resize",function(e){window.innerWidth<720?(hMenu.classList="hamburger-menu",console.log("hola mundo")):(hmenu.classList.remove="hamburger-menu",console.log("adios"))});
