...
;
"use strict";function injectMenu(e){var n=!1;window.innerWidth<e&&0==n?(hamgurgerMenu.classList="hamburger-menu",n=!0,console.log("Se inyectó el menú xoro")):(hamgurgerMenu.classList.remove="hamburger-menu",console.log("adios"))}var hamgurgerMenu=document.getElementById("js-hamburger-menu");hamgurgerMenu&&console.log("si existe loco"),window.addEventListener("resize",function(e){console.log("memememe"),hamgurgerMenu&&injectMenu(window.innerWidth)}),console.log("asdfasdf");
